...
{
    class Rat<HFood, PFood, FFood> : CreatureOmnivorous<HFood, PFood, FFood>, ISmallAnimal
    {
        public Rat(int x, int y, bool gender, Random randomm, List<Cell> objectsListt,
        ...
        {
            SearchLove<Rat<HFood, PFood, FFood>>();
        }
        ...
        {
            return new Rat<HFood, PFood, FFood>(
                            x: x + razbrosX,
                            y: y + razbrosY,
                            gender: babyGender,
                            randomm: random,
